...
function getFollowups(sensation) {
    ...
    apiurl = 'https://web-02.girumtesfaye.tech/api/symptoms/Sensation/' + sensation
    return fetch(apiurl)
    .then(response => {
...
function getQuestions(symptom_id) {
    ...
    apiurl = 'https://web-02.girumtesfaye.tech/api/questions/' + symptom_id
    return fetch(apiurl)
    .then(response => {
        // Check if the request was successful (status code 2xx)
        if (!response.ok) {
...
function getProblem_symptom_id(symptom_id) {
    apiurl = 'https://web-02.girumtesfaye.tech/api/problems/Symptom_id/' + symptom_id;
    return fetch(apiurl)
    .then(response => {
        // Check if the request was successful (status code 2xx)
        if (!response.ok) {
...
function getProblem_question_id(question_id) {
    apiurl = 'https://web-02.girumtesfaye.tech/api/problems/' + question_id;
    return fetch(apiurl)
    .then(response => {
        // Check if the request was successful (status code 2xx)
        if (!response.ok) {
...
function getTips_id(tip_id) {
    apiurl = 'https://web-02.girumtesfaye.tech/api/tips/' + tip_id;
    return fetch(apiurl)
    .then(response => {
        // Check if the request was successful (status code 2xx)
        if (!response.ok) {
...
function getObd_code(code) {
    ...
    apiurl = 'https://web-02.girumtesfaye.tech/api/obd/' + code;
    return fetch(apiurl)
    .then(response => {
        // Check if the request was successful (status code 2xx)
        if (!response.ok) {
